...
from ColBERT.colbert.modeling.tokenization.doc_tokenization import DocTokenizer
from ColBERT.colbert.modeling.tokenization.query_tokenization import QueryTokenizer
...
def collate_fn(
    ...
    features = [
        ...
        for i, single_str_batch in enumerate(zip(*[texts for texts, scores in batch]))
    ]
    scores = [
...
def new_collate(
    ...
    # instances are always returned
    datasets, data = zip(*batch)
