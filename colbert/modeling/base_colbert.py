...
class BaseColBERT(torch.nn.Module):
    ...
    def __init__(self, name_or_path, colbert_config=None):
        ...
        # TODO: Note that this tokenizer isn't exactly the one we actually use (doesn't have the Q/D markers)
        # but it's use in training is limited to getting the ids of punctuation to mask/skip in document embedding
